...
module.exports = (function() {
  var console = { log: require("debug")("OEMDriver") }
  ...
  OEM.prototype.start = function() {
    ...
    // For RFM69CW
    this._serialPort = new serialModule.SerialPort(this._config.port, { parser: serialModule.parsers.readline(delimiter), baudrate: 38400}, false);
...
//    this._serialPort = new serialModule.SerialPort(this._config.port, { parser: serialModule.parsers.readline(delimiter), baudrate: 9600}, false);
    ...
    this._serialPort.open(function(err) {
      if (typeof err !== "undefined" && err !== null) {
        ...
        setTimeout(function() { self._serialPort.write(self._config.oemNetwork + "g"); }, 1500);

        // Set the radio node ID to 1.
